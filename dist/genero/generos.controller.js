...
let GenerosController = class GenerosController {
    constructor(generosServer) {
        this.generosServer = generosServer;
    }
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_b = typeof create_genero_dto_1.CreateGeneroDto !== "undefined" && create_genero_dto_1.CreateGeneroDto) === "function" ? _b : Object, Number]),
    __metadata("design:returntype", Promise)
