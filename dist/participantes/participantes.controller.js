...
let ParticipantesController = class ParticipantesController {
    constructor(participantesServer) {
        this.participantesServer = participantesServer;
    }
    ...
    async update(updateParticipante, id) {
        return this.participantesServer.updateOneParticipante(id, updateParticipante);
    }
};
__decorate([
